...
int main() 
{
    ...
    choice1 = 1;
    choice2 = silver;
    verify("Choose invalid card to trash", cardEffectMine(thisPlayer, choice1, choice2, &testG, handpos) == -1);
    testG.hand[thisPlayer][1] = silver;
    choice2 = estate;
    verify("Choose invalid card to gain", cardEffectMine(thisPlayer, choice1, choice2, &testG, handpos) == -1);
    testG.hand[thisPlayer][1] = copper;
    choice2 = gold;
    verify("Choose treasure too expensive", cardEffectMine(thisPlayer, choice1, choice2, &testG, handpos) == -1);
    ...
    choice1 = 0;
    choice2 = silver;
    int test = cardEffectMine(thisPlayer, choice1, choice2, &testG, handpos);
    ...
    choice1 = 0;
    choice2 = gold;
    test = cardEffectMine(thisPlayer, choice1, choice2, &testG, handpos);
